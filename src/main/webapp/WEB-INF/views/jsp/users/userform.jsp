	...
	<form:form class="form-horizontal" method="post" modelAttribute="userForm" action="${userActionUrl}">
		...
		<spring:bind path="role">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:checkboxes path="role" items="${roleList}" element="label class='checkbox-inline'" />
					<br />
		...
		<spring:bind path="specialty">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-5">
					<form:select path="specialty" items="${specialtyList}" multiple="true" size="5" class="form-control" />
					<form:errors path="specialty" class="control-label" />
				</div>
				<div class="col-sm-5"></div>
			</div>
		</spring:bind>
